...
window.addEventListener('message', event => {
  ...
  if (data.type === 'PING_REXEL_EXTENSION') {
    window.postMessage({source:'rexel-extension', type:'REXEL_EXTENSION_READY', version:'0.4.1'}, event.origin);
    return;
  }
...
window.postMessage({source:'rexel-extension', type:'REXEL_EXTENSION_READY', version:'0.4.1'}, location.origin);
